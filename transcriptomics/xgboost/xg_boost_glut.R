...
rm(list = c("obj.mouse", "obj.opossum"))
...
rm(list = c("obj.combined", "obj.list"))
...
MO_model <- TrainXGBoost(obj.sct.list[["Mouse_M1"]], 
                         ...
                         train.clusters = "subclass_label", 
                         test.clusters = "RNA_snn_res.2", 
...
# Apply model
Idents(obj.sct.list[["Mouse_M1"]]) <- "subclass_label"
Idents(obj.sct.list[["Opossum_M1"]]) <- "RNA_snn_res.2"
