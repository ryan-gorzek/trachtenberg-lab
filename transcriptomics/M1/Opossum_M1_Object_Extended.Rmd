...
data_path <- "E:/Opossum_M1/output/Extended/"
...
FeaturePlot(obj.opossum, reduction = "umap", features = c("Chrm2"), raster = FALSE) + NoLegend() + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum, reduction = "umap", features = c("Chrm3"), raster = FALSE) + NoLegend() + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
