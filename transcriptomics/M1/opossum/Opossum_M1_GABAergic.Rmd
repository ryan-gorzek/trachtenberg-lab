...
obj.opossum.gabaergic <- readRDS("E:/Transcriptomics_M1/Opossum/seurat/opossum_m1_gabaergic.rds")
...
obj.opossum.gabaergic <- subset(obj.opossum.gabaergic, idents = c(11, 13, 16), invert = TRUE)
...
subclass.idx.opossum$SCT_snn_res.1$Pvalb <- c("1", "4", "5", "6", "7", "12", "13", "14")
subclass.idx.opossum$SCT_snn_res.1.5$Pvalb <- c("1", "3", "5", "6", "9", "11", "13", "14", "15")
subclass.idx.opossum$SCT_snn_res.2$Pvalb <- c("2", "3", "6", "7", "9", "11", "13", "14", "15", "16", "17", "22", "24", "27")

subclass.idx.opossum$SCT_snn_res.1$Sst <- c("3", "9", "10", "11", "17")
subclass.idx.opossum$SCT_snn_res.1.5$Sst <- c("4", "7", "10", "12", "17", "20")
subclass.idx.opossum$SCT_snn_res.2$Sst <- c("1", "8", "12", "19", "21", "26")

subclass.idx.opossum$SCT_snn_res.1$Vip <- c("2")
subclass.idx.opossum$SCT_snn_res.1.5$Vip <- c("2", "16")
subclass.idx.opossum$SCT_snn_res.2$Vip <- c("5", "18", "20")

subclass.idx.opossum$SCT_snn_res.1$Lamp5 <- c("8", "15", "16")
subclass.idx.opossum$SCT_snn_res.1.5$Lamp5 <- c("8", "18", "19")
subclass.idx.opossum$SCT_snn_res.2$Lamp5 <- c("4", "23", "25")
...
markers.opossum.gabaergic <- IdentMarkerDict(obj.opossum.gabaergic, subclass.labels, ident.labels,
                                        "E:/Transcriptomics_M1/Opossum/seurat/marker_genes/GABAergic/markerdict_clusters.rds")
SaveDotPlots(obj.opossum.gabaergic, markers.opossum.gabaergic,
             subclass.labels, ident.labels,
             "E:/Transcriptomics_M1/Opossum/seurat/cell_types/GABAergic/", "ENSMODG")
SaveFeaturePlots(obj.opossum.gabaergic, markers.opossum.gabaergic,
                 subclass.labels, ident.labels,
                 "E:/Transcriptomics_M1/Opossum/seurat/cell_types/GABAergic/")
