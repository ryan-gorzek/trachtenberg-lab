...
cells.gabaergic <- WhichCells(obj.opossum, ident = c(7, 13, 19, 27, 29, 30))
...
SaveH5Seurat(obj.opossum.gabaergic, "E:/Opossum_M1/seurat/opossum_m1_gabaergic_monDom5.h5seurat", overwrite = TRUE, verbose = TRUE)
