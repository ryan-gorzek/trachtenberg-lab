...
obj.opossum.nonneuronal$subclass <- obj.opossum.nonneuronal$SCT_snn_res.2
obj.opossum.nonneuronal$type <- obj.opossum.nonneuronal$SCT_snn_res.2
# obj.mouse.nonneuronal.P38 <- readRDS("E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_P38_nonneuronal_processed.rds")

objs <- list(obj.opossum.nonneuronal, obj.mouse.nonneuronal)
...
DimPlot(obj.opossum.nonneuronal, reduction = "umap", group.by = "SCT_snn_res.1", label = TRUE, raster = FALSE, shuffle = TRUE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
DimPlot(obj.opossum.nonneuronal, reduction = "umap", group.by = "all_SCT_snn_res.1", label = TRUE, raster = FALSE, shuffle = TRUE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
...
obj.integrated <- IntegrateObjects(objs[[1]], objs[[2]], resolutions = c(1), nfeatures = 3000, subsample = 10000)
...
subclasses <- c(c("Astro", "Endo", "Micro", "OD", "OPC", "VLMC", "SMC", "Peri"), as.character(1:26))
