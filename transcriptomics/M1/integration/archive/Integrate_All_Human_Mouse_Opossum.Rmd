...
obj.mouse <- LoadH5Seurat("E:/Transcriptomics_M1/Mouse/seurat/mouse_m1_all.h5seurat")
...
obj.human <- LoadH5Seurat("E:/Transcriptomics_M1/Human/seurat/human_m1_all.h5seurat")
obj.human$species <- "Human"
obj.human$subclass <- obj.human$subclass_label
obj.human$subclass[obj.human$subclass == "Sst Chodl"] <- "Sst"

# obj.mouse <- obj.mouse[, sample(colnames(obj.mouse), size = ncol(obj.human), replace = FALSE)]
# obj.opossum <- obj.opossum[, sample(colnames(obj.opossum), size = ncol(obj.human), replace = FALSE)]
