...
mouse.counts <- mouse.counts[, -1]
mouse.counts$Glutamatergic <- rowSums(mouse.counts[, c("L2.3.IT", "L5.ET", "L5.IT", "L5.6.NP", "L6.CT", "L6.IT")])
...
opossum.counts$Glutamatergic <- rowSums(opossum.counts[, c("L2.3.IT", "L5.ET", "L5.IT", "L5.6.NP", "L6.CT")])
...
neuronal_class <- ggplot(class.counts, aes(class.counts, x = factor(cell.identity, level = c("Glutamatergic", "GABAergic")), y = fraction, fill = species)) +
...
glutamatergic_subclass <- ggplot(class.counts, aes(x = factor(cell.identity, level = c("L2.3.IT", "L5.IT", "L6.IT", "L5.ET", "L6.CT", "L5.6.NP", "L6b")), y = fraction, fill = species)) +
    geom_bar(stat = "summary", fun = "median", position = position_dodge(width = 0.8), width = 0.75) +
    geom_point(colour = "black", position = position_dodge(width = 0.8), size = 1) +
...
gabaergic_subclass <- ggplot(class.counts, aes(x = factor(cell.identity, level = c("Pvalb", "Sst", "Sst.Chodl", "Vip", "Lamp5", "Sncg", "Meis2")), y = fraction, fill = species)) +
    geom_bar(stat = "summary", fun = "median", position = position_dodge(width = 0.8), width = 0.75) +
    geom_point(colour = "black", position = position_dodge(width = 0.8), size = 1) +
...
Idents(obj.combined) <- "subclass"
markers <- FindConservedMarkers(obj.combined, ident.1 = "Peri", grouping.var = "dataset")
