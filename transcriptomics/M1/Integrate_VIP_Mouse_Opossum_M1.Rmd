...
obj.mouse <- LoadH5Seurat("E:/Mouse_M1/seurat/mouse_m1_gabaergic_vip.h5seurat")
obj.mouse[["dataset"]] <- "Mouse_M1"
obj.opossum <- LoadH5Seurat("E:/Opossum_M1/seurat/opossum_m1_gabaergic_vip.h5seurat")
...
DimPlot(integ.combined, reduction = "umap", group.by = "dataset", raster = FALSE) + xlim(-10, 10) + ylim(-10, 10) + coord_equal()
DimPlot(integ.combined, reduction = "umap", split.by = "dataset", group.by = "subclass_label", raster = FALSE) + xlim(-10, 10) + ylim(-10, 10) + coord_equal()
