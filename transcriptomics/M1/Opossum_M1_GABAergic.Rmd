...
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Erbb4")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Nrg1")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
...
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrm1")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrm2")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrm3")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrm4")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrm5")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna1")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna2")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna3")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna4")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna5")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna6")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna7")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
# FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna9")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrna10")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrnb1")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrnb2")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrnb3")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrnb4")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrnd")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrne")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
# FeaturePlot(obj.opossum.gabaergic, reduction = "umap", features = c("Chrng")) + xlim(-15, 15) + ylim(-15, 15) + coord_equal()
...
Idents(obj.opossum.gabaergic) <- "RNA_snn_res.3"
cells.pv <- WhichCells(obj.opossum.gabaergic, ident = c("1", "2", "3", "5", "6", "7", "10", "11", "14", "16", "20", "27"))
obj.opossum.gabaergic$subclass <- ifelse(colnames(obj.opossum.gabaergic) %in% cells.pv, "Pvalb", "ambiguous")

cells.sst <- WhichCells(obj.opossum.gabaergic, ident = c("4", "8", "9", "12", "13", "24", "26", "28"))
obj.opossum.gabaergic$subclass[cells.sst] <- "Sst"

cells.chodl <- WhichCells(obj.opossum.gabaergic, ident = c("32"))
obj.opossum.gabaergic$subclass[cells.chodl] <- "Sst Chodl"

cells.vip <- WhichCells(obj.opossum.gabaergic, ident = c("15", "19", "21", "23"))
obj.opossum.gabaergic$subclass[cells.vip] <- "Vip"

cells.lamp5 <- WhichCells(obj.opossum.gabaergic, ident = c("17", "22", "30"))
