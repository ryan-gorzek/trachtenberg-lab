...
DimPlot(obj.opossum.glutamatergic, reduction = "umap", group.by = "RNA_snn_res.1", label = TRUE, raster = FALSE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
...
markers <- FindMarkers(obj.opossum.glutamatergic, ident.1 = 7)
...
cells.l5it <- WhichCells(obj.opossum.glutamatergic, ident = c("5", "6", "7", "11", "12", "16"))
...
SaveH5Seurat(obj.opossum.glutamatergic, "E:/Opossum_M1/seurat/opossum_m1_glutamatergic_filt.h5seurat", overwrite = TRUE, verbose = TRUE)
