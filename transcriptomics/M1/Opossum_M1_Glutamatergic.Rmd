...
DimPlot(obj.opossum.glutamatergic, reduction = "umap", label = TRUE, raster = FALSE) + NoLegend() + xlim(-17, 13) + ylim(-18, 12) + coord_equal()
DimPlot(obj.opossum.glutamatergic, reduction = "umap", group.by = "sample", raster = FALSE) + xlim(-17, 13) + ylim(-18, 12) + coord_equal()
...
cells.l23it <- WhichCells(obj.opossum.glutamatergic, ident = c("2", "3", "11", "13"))
obj.opossum.glutamatergic$subclass <- ifelse(colnames(obj.opossum.glutamatergic) %in% cells.l23it, "L2/3 IT", "ambiguous")

cells.l5it <- WhichCells(obj.opossum.glutamatergic, ident = c("5", "6", "10", "12", "16"))
...
cells.l6ct <- WhichCells(obj.opossum.glutamatergic, ident = c("1", "4", "9"))
...
Idents(obj.opossum.glutamatergic.l23it) <- "RNA_snn_res.0.5"
...
DimPlot(obj.opossum.glutamatergic.l23it, reduction = "umap", group.by = "RNA_snn_res.0.5", label = TRUE, label.size = 4, raster = FALSE) + NoLegend()  + xlim(-4, 10) + ylim(0, 14) + coord_equal()
FeaturePlot(obj.opossum.glutamatergic.l23it, "Snx32")  + xlim(-4, 10) + ylim(0, 14) + coord_equal()
VlnPlot(obj.opossum.glutamatergic.l23it, "Snx32", group.by = "RNA_snn_res.0.5")
...
Idents(obj.opossum.glutamatergic) <- "subclass"
SaveH5Seurat(obj.opossum.glutamatergic, "E:/Opossum_M1/seurat/opossum_m1_glutamatergic_types.h5seurat", overwrite = TRUE, verbose = TRUE)
