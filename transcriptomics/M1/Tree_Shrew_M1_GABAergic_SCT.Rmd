...
DimPlot(obj.treeshrew.gabaergic.sct, reduction = "umap", group.by = "sample", raster = FALSE) + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
...
obj.treeshrew.gabaergic.sct <- subset(obj.treeshrew.gabaergic.sct, idents = c("5", "12", "21"), invert = TRUE)
