...
# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/HMO_Class_Proportion.svg", plot=hmo_class, width=3.5, height=3)
...
# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/HMO_GABAergic_Subclass_Proportion.svg", plot=hmo_gabaergic, width=4, height=3)
...
# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/HMO_GABAergic_Subclass_Proportion.svg", plot=hmo_gabaergic, width=4, height=3)
# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/MO_GABAergic_Subclass_Proportion.png", plot=mo_gabaergic, width=4, height=3)
...
ggplot(class.counts, aes(x = factor(cell.identity, level = c("Pvalb", "CGE")), y = fraction, fill = species)) +
    geom_bar(stat = "summary", fun = "median", position = position_dodge(width = 0.8), width = 0.75) +
    geom_point(colour = "black", position = position_dodge(width = 0.8), size = 1) +
    ...
    theme_classic() + theme(axis.text = element_text(color = "black"), legend.text = element_text(size = 10)) + 
    labs(x = NULL, y = "Subclass Proportion", fill = NULL) + 
    scale_fill_manual("legend", values = c("Pvalb" = "#315867", "CGE" = "#9db1d2"))

# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/MO_Pvalb_CGE_Proportion.svg", plot=mo_pv_cge, width=3.5, height=3)
# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/MO_Pvalb_CGE_Proportion.png", plot=mo_pv_cge, width=3.5, height=3)
...
# ggsave(file="G:/Shared drives/Opossum transcriptomics/figures/CGE_PV_Fraction.svg", plot=cge_pv_fraction, width=3.5, height=3)
