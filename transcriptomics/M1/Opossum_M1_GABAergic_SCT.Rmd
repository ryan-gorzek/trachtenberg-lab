...
obj.opossum.gabaergic.sct <- subset(obj.opossum.gabaergic.sct, idents = c("5", "12", "21"), invert = TRUE)
...
SaveH5Seurat(obj.opossum.gabaergic.sct, "E:/Opossum_M1/seurat/opossum_m1_gabaergic_sct.h5seurat", overwrite = TRUE, verbose = TRUE)
