...
obj.mouse.full <- LoadH5Seurat("E:/Mouse_M1/seurat/mouse_m1_gabaergic.h5seurat")
obj.mouse.full$dataset <- "Mouse_M1"

obj.opossum <- LoadH5Seurat("E:/Opossum_M1/seurat/opossum_m1_gabaergic_sct.h5seurat")
obj.opossum$dataset <- "Opossum_M1"

obj.mouse <- obj.mouse.full[, sample(colnames(obj.mouse.full), size = ncol(obj.opossum), replace = FALSE)]
