...
cells.glutamatergic <- WhichCells(obj.opossum, ident = c(1, 2, 3, 4, 5, 7, 9, 11, 12, 13, 15, 16, 17, 18, 20, 24, 28, 30))
obj.opossum$class <- ifelse(colnames(obj.opossum) %in% cells.glutamatergic, "glutamatergic", "ambiguous")

cells.gabaergic <- WhichCells(obj.opossum, ident = c(6, 14, 19, 22, 32, 33))
