...
p <- ggplot(density_combined, aes(x = factor(position, level = c("above", "below")), y = density_cells_per_um2, fill = species)) +
  geom_bar(stat = "identity", position = position_dodge(width = 0.8), width = 0.75) +
  scale_x_discrete(labels = c("Above", "Below")) +
  scale_y_continuous(breaks = c(0, 500, 1000, 1500, 2000), expand = c(0, 0), limits = c(0, 2000)) +
