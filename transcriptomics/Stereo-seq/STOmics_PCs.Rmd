...
subclass_pairs <- list(
  "L2/3" = list(subclass = c("IT_A", "C"), regimes = list(c(0, 1500))),
  "L4"   = list(subclass = c("IT_B", "B"), regimes = list(c(0, 1500))),
  "L5IT" = list(subclass = c("IT_C", "B"), regimes = list(c(0, 1500)))
)

# Loop over subclass pairs
for (mouse_subclass in names(subclass_pairs)) {
  opossum_subclass <- subclass_pairs[[mouse_subclass]]$subclass[1]
  vertex <- paste0("Geodesic_to_Vertex_", subclass_pairs[[mouse_subclass]]$subclass[2])
