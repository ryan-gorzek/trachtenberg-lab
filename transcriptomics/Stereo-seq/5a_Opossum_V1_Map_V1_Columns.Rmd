...
obj.i <- LabelByNearestNeighbors(obj.i, "SCT_snn_res.0.3", fraction = 0.25, n.neighbors = 100)
...
obj.glutamatergic.IT <- subset(obj.glutamatergic, SCT_snn_res.0.2 %in% c(1, 2, 4, 5))
Idents(obj.glutamatergic.IT) <- "SCT_snn_res.0.2"
