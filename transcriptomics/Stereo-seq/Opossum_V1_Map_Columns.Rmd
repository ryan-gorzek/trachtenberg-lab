...
p <- ImageDimPlot(obj.ctx.glutamatergic, fov = "COL", size = 3, cols = colors, axes = TRUE) + coord_fixed(ratio = 0.77) + scale_y_continuous(breaks = c(0, 400, 800, 1200, 1600))
...
p <- ImageDimPlot(obj.ctx.gabaergic, fov = "COL", size = 3, cols = colors[1:6], axes = TRUE) + coord_fixed(ratio = 0.77) + scale_y_continuous(breaks = c(0, 400, 800, 1200, 1600))
