...
obj.mouse$glutamatergic <- readRDS("E:/STOmics/seurat/Mouse/mouse_stereoseq_ctx_glutamatergic_COLs_integrated.rds")
obj.mouse$gabaergic <- readRDS("E:/STOmics/seurat/Mouse/mouse_stereoseq_ctx_gabaergic_COLs_integrated.rds")
obj.mouse$nonneuronal <- readRDS("E:/STOmics/seurat/Mouse/mouse_stereoseq_ctx_nonneuronal_COLs_integrated.rds")
...
# Cux2, Rorb, Kcnh1, Gria4, Foxp2, Deptor, Fezf2, Sox5

feature <- "Sox5"
ImageFeaturePlotOrdered(obj.mouse$glutamatergic, feature, max.cutoff = 2, ratio = 1.5, yticks = c(0, 500, 1000, 1500))
ImageFeaturePlotOrdered(obj.opossum$glutamatergic, feature, max.cutoff = 2, ratio = 0.77 * 1.5, yticks = c(0, 400, 800, 1200, 1600))
