...
feature <- "Cntnap5a"
ImageFeaturePlotOrdered(obj.mouse$glutamatergic, feature, max.cutoff = 1, ratio = 1.5, yticks = c(0, 500, 1000, 1500))
ImageFeaturePlotOrdered(obj.opossum$glutamatergic, feature, max.cutoff = 1, ratio = 0.77 * 1.5, yticks = c(0, 400, 800, 1200, 1600))
