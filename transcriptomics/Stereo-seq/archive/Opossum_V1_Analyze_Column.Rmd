...
obj.ctx.glutamatergic.COL <- readRDS("E:/STOmics/seurat/Opossum/opossum_stereoseq_ctx_1_COL_clustered_mapped.rds")
...
subclass_order <- c("IT_A", "IT_B", "IT_C", "IT_D", "L5NP", "L5PT", "L6CT", "L6b")  # Define your desired order
...
colors_list_density <- list(IT_A = "#FF6C88", 
                            IT_B = "#1E90FF", 
                            IT_C = "#FF4500", 
                            IT_D = "#f7f023", 
                            L5NP = "#de23f7", 
