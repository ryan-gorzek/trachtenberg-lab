...
DimPlot(obj.i.opossum, group.by = "SCT_snn_res.0.2", label = TRUE)
...
DimPlot(obj.i.opossum.IT, reduction = "pca", dims = c(2, 3), cols = colors_list[subclasses.opossum], label = TRUE, pt.size = 2) + NoLegend() + xlim(-30, 35) + ylim(-30, 35) + coord_equal()
Idents(obj.i.opossum.IT) <- "SCT_snn_res.0.2"
DimPlot(obj.i.opossum.IT, reduction = "pca", dims = c(2, 3), label = TRUE, pt.size = 2) + NoLegend() + xlim(-30, 35) + ylim(-30, 35) + coord_equal()
