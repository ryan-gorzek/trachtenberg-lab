...
section.cells <- read.csv("E:/STOmics/seurat/Mouse/selected_barcodes.csv", header = FALSE)
...
saveRDS(df, "E:/STOmics/seurat/Mouse/mouse_section_subclass_labels.rds")
...
# Read the data
df <- readRDS("E:/STOmics/seurat/Mouse/mouse_section_subclass_labels.rds")
...
obj.section.plot <- subset(obj.section, subclass_nn %in% c("L2/3", "L4", "L5IT", "L5NP", "L5PT", "L6IT", "L6CT", "L6b", "OD"))

Idents(obj.section.plot) <- "subclass_nn"
subclasses.mouse <- c("L2/3", "L4", "L5IT", "L5NP", "L5PT", "L6IT", "L6CT", "L6b", 
                         "OD")
colors <- hcl.colors(length(subclasses.mouse), palette = "dynamic")
colors[2] <- "#FF6347"
levels(obj.section.plot) <- subclasses.mouse
p <- ImageDimPlot(obj.section.plot, cols = colors, size = 2.5)
ggsave("E:/Opossum_Paper/Figure 3/Mouse_Section.svg", plot = p)
