...
df <- data.frame(cell = c(), subclass_nn = c())
all.names <- colnames(obj.section)

obj.i <- IntegrateObjects(obj, obj.section, resolutions = c(0.5), subsample = FALSE)
...
DimPlot(obj.i, group.by = "subclass")
DefaultAssay(obj.i.section) <- "RNA"
ImageFeaturePlot(obj.i.section, "nCount_RNA")
