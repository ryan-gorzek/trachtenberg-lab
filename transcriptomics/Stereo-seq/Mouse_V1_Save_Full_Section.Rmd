...
for (i in 1:2) { # (i in 1:ceiling(ncol(obj.section) / ncol(obj))) {
...
ImageDimPlot(obj.section,  group.by = "subclass_nn", size = 1)
print(table(obj.section$subclass_nn)["None"] / sum(table(obj.section$subclass_nn)))
