...
column.coords <- Crop(obj[["FOV"]], x = c(-9500, -7500), y = c(-14400, -12800), coords = "plot")
...
saveRDS(obj.ctx, "E:/STOmics/seurat/Opossum/opossum_stereoseq_ctx_COL1_EXT.rds")
