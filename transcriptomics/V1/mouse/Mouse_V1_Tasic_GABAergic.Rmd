...
obj.mouse.gabaergic <- readRDS("E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_tasic_gabaergic.rds")
...
subclass.idx.mouse$type$Sst <- c("Sst_A", "Sst_B", "Sst_C", "Sst_D", "Sst_E", "Sst_F", "Sst_G", "Sst_H", "Sst_I", "Sst_J", "Sst_K", "Sst_L", "Sst_M", "Sst_N", "Sst_O", "Sst_P", "Sst_Q", "Sst_R", "Sst_S", "Sst_T", "Sst_U")

subclass.idx.mouse$type$Vip <- c("Vip_A", "Vip_B", "Vip_C", "Vip_D", "Vip_E", "Vip_F", "Vip_G", "Vip_H", "Vip_I", "Vip_J", "Vip_K", "Vip_L", "Vip_M", "Vip_N", "Vip_O", "Vip_P")

subclass.idx.mouse$type$Lamp5 <- c("Lamp5_A", "Lamp5_B", "Lamp5_C", "Lamp5_D", "Lamp5_E", "Lamp5_F", "Lamp5_G")

subclass.idx.mouse$type$Sncg <- c("Sncg_A", "Sncg_B", "Sncg_C", "Sncg_D")

subclass.idx.mouse$type$Serpinf1 <- c("Serpinf1_A", "Serpinf1_B")

subclass.idx.mouse$type$Meis2 <- c("Meis2")
...
levels(obj.mouse.gabaergic) <- c("Pvalb", "Sst", "Vip", "Lamp5", "Sncg", "Serpinf1", "Meis2")
...
subclass.labels <- c("Pvalb", "Sst", "Vip", "Lamp5", "Sncg", "Serpinf1")
ident.labels <- c("type")

subclass.markers.mouse.gabaergic <- SubclassMarkerDict(obj.mouse.gabaergic, "subclass",
                                                       "E:/Transcriptomics_V1/Mouse/seurat/marker_genes/GABAergic/Tasic/markerdict_subclass.rds")
markers.mouse.gabaergic <- IdentMarkerDict(obj.mouse.gabaergic, subclass.labels, ident.labels,
                                        "E:/Transcriptomics_V1/Mouse/seurat/marker_genes/GABAergic/Tasic/markerdict_types.rds")
SaveDotPlots(obj.mouse.gabaergic, markers.mouse.gabaergic,
             subclass.labels, ident.labels,
             "E:/Transcriptomics_V1/Mouse/seurat/cell_types/GABAergic/Tasic/", "ENSMUSG")
SaveFeaturePlots(obj.mouse.gabaergic, markers.mouse.gabaergic,
                 subclass.labels, ident.labels,
                 "E:/Transcriptomics_V1/Mouse/seurat/cell_types/GABAergic/Tasic/")

PlotSubclassGeneCounts(subclass.markers.mouse.gabaergic, "subclass", 
                       c("Pvalb", "Sst", "Vip", "Lamp5", "Sncg", "Serpinf1", "Meis2")) + theme(aspect.ratio = 1)
...
SaveSubclassConfusionMatrices(obj.mouse.gabaergic, "subclass",
                              c("Pvalb", "Sst", "Vip", "Lamp5", "Sncg", "Serpinf1", "Meis2"),
                              "E:/Transcriptomics_V1/Mouse/seurat/cell_types/GABAergic/Tasic/")
...
saveRDS(obj.mouse.gabaergic, "E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_tasic_gabaergic_processed.rds")
