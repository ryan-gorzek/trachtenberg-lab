...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'CT-MOUSE', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Mouse/seurat/wgcna/CT/module_networks'
)
...
EnrichrBarPlot(
  seurat_obj,
  outdir = "E:/Transcriptomics_V1/Mouse/seurat/wgcna/CT/enrichr_plots", # name of output directory
...
saveRDS(seurat_obj, "E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_ct_wgcna.rds")
