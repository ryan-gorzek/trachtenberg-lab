...
%% Shared (Mouse Space, Species)

% Load data from CSV
data = readtable('E:/Transcriptomics_V1/Integration/PCs/IT/shared_mouse_pc_data_subsample_with_subclass.csv');
...
%% Shared (Opossum Space, Species)

% Load data from CSV
data = readtable('E:/Transcriptomics_V1/Integration/PCs/IT/shared_opossum_pc_data_subsample_with_subclass.csv');
...
%% Shared (Opossum, Opossum Subclass)
