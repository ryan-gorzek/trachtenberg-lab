...
seurat_obj <- readRDS("E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_P38_gabaergic_processed.rds")
...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'CGE-MOUSE', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Mouse/seurat/wgcna/CGE/module_networks'
)
...
EnrichrBarPlot(
  seurat_obj,
  outdir = "E:/Transcriptomics_V1/Mouse/seurat/wgcna/CGE/enrichr_plots", # name of output directory
...
saveRDS(seurat_obj, "E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_cge_wgcna.rds")
