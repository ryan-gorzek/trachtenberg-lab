...
seurat_obj <- SetDatExpr(
                              seurat_obj,
                              group_name = c("Pvalb", "Sst", "Vip"), # the name of the group of interest in the group.by column
...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'E:/Transcriptomics_V1/Mouse/seurat/wgcna/GABAergic/INH-MOUSE', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
seurat_obj <- ModuleConnectivity(
  seurat_obj,
  group.by = 'subclass', group_name = c('Pvalb', 'Sst', 'Vip')
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Mouse/seurat/wgcna/GABAergic/ModuleNetworks'
)
