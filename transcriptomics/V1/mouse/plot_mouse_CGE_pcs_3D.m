...
% Load data from CSV
data = readtable('E:/Transcriptomics_V1/Integration/PCs/CGE/mouse_pc_data_subsample_with_subclass.csv');
...
% Load data from CSV
data = readtable('E:/Transcriptomics_V1/Integration/PCs/CGE/opossum_pc_data_subsample_with_subclass.csv');
...
% Load data from CSV
data1 = readtable('E:/Transcriptomics_V1/Integration/PCs/CGE/opossum_pc_data_shared_subsample_with_subclass.csv');
data2 = readtable('E:/Transcriptomics_V1/Integration/PCs/CGE/mouse_pc_data_shared_subsample_with_subclass.csv');
...
for i = 1:length(species_groups)
    idx = (subclass_idx == i);
    scatter3(pc1(idx), pc2(idx), pc3(idx), 5, cmap(i, :), 'filled', 'DisplayName', species_groups{i});
end
