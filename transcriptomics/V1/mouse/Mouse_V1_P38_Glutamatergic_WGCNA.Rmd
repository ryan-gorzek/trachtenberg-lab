...
seurat_obj <- SetDatExpr(
                              seurat_obj,
                              group_name = c("L2/3", "L4", "L5IT", "L5NP", "L5PT", "L6IT", "L6CT"), # the name of the group of interest in the group.by column
...
PlotDendrogram(seurat_obj, main='Glutamatergic hdWGCNA Dendrogram')
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Mouse/seurat/wgcna/Glutamatergic/module_networks'
)
...
EnrichrBarPlot(
  seurat_obj,
  outdir = "E:/Transcriptomics_V1/Mouse/seurat/wgcna/GABAergic/enrichr_plots", # name of output directory
