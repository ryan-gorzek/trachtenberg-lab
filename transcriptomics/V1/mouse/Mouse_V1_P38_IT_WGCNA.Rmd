...
seurat_obj <- readRDS("E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_P38_glutamatergic_processed.rds")
Idents(seurat_obj) <- "subclass"
seurat_obj <- subset(seurat_obj, idents = c("L2/3", "L4", "L5IT", "L6IT"))
...
seurat_obj <- SetDatExpr(
                              seurat_obj,
                              group_name = c("L2/3", "L4", "L5IT", "L6IT"), # the name of the group of interest in the group.by column
...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'EXC-MOUSE', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
PlotDendrogram(seurat_obj, main='IT hdWGCNA Dendrogram')
...
seurat_obj <- ModuleConnectivity(
  seurat_obj,
  group.by = 'subclass', group_name = c("L2/3", "L4", "L5IT", "L5NP", "L5PT", "L6IT", "L6CT")
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Mouse/seurat/wgcna/IT/module_networks'
)
...
Idents(seurat_obj) <- "subclass"
seurat_obj_L23 <- subset(seurat_obj, idents = c("L2/3"))

ModuleRadarPlot(
  seurat_obj_L23,
  group.by = 'type',
  barcodes = seurat_obj_L23@meta.data %>% rownames(),
  axis.label.size=2,
  grid.label.size=2
)
...
EnrichrBarPlot(
  seurat_obj,
  outdir = "E:/Transcriptomics_V1/Mouse/seurat/wgcna/IT/enrichr_plots", # name of output directory
...
saveRDS(seurat_obj, "E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_it_wgcna.rds")
