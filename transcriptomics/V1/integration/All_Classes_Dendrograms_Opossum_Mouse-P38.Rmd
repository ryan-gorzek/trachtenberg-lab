...
obj.mouse <- BuildClusterTree(obj.mouse, assay = "SCT", dims = 1:30)
...
# ggsave("E:/Opossum_Paper/Figure 1/Mouse_Subclass_Cladogram.png", plot = p, dpi = 300)
# ggsave("E:/Opossum_Paper/Figure 1/Mouse_Subclass_Cladogram.svg", plot = p, dpi = 300)
...
obj.opossum <- BuildClusterTree(obj.opossum, assay = "SCT", dims = 1:100)
