...
obj.opossum.nonneuronal$subclass <- obj.opossum.nonneuronal$SCT_snn_res.1
obj.opossum.nonneuronal$type <- obj.opossum.nonneuronal$SCT_snn_res.1
...
obj.integrated <- IntegrateObjects(objs[[1]], objs[[2]], resolutions = c(1), nfeatures = 3000, subsample = TRUE)
...
subclasses <- c(c("Astro", "Endo", "Micro", "OD", "OPC", "VLMC"), as.character(1:15))
