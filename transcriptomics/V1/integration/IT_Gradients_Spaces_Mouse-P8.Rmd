...
DimPlot(obj.combined.IT, reduction = "pca", dims = c(2, 3), cols = c("#aaaaaa", "#c692b8"), group.by = "species", pt.size = 1, label = FALSE, shuffle = TRUE, raster = FALSE) + xlim(-40, 25) + ylim(-30, 35) + coord_equal()
DimPlot(obj.combined.IT, reduction = "pca", dims = c(2, 3), cols = colors_list[subclasses.opossum.mouse], group.by = "subclass", split.by = "species", pt.size = 1, label = TRUE, shuffle = TRUE, raster = FALSE) + NoLegend() + xlim(-40, 25) + ylim(-30, 35) + coord_equal()
