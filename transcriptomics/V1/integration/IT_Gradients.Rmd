...
DimPlot(obj.mouse.IT, reduction = "pca", group.by = "sample", pt.size = 1, shuffle = TRUE, raster = FALSE) + xlim(-30, 35) + ylim(-45, 20) + coord_equal()
subclasses.mouse <- c("L2/3", "L4", "L5IT", "L6IT")
Idents(obj.mouse.IT) <- "subclass"
levels(obj.mouse.IT) <- subclasses.mouse
pl <- DimPlot(obj.mouse.IT, reduction = "pca", cols = colors_list[subclasses.mouse], pt.size = 1, label = TRUE, shuffle = TRUE, raster = FALSE) + NoLegend() + xlim(-30, 35) + ylim(-45, 20) + coord_equal()
pl[[1]]$layers[[1]]$aes_params$alpha =  0.8
pl
FeaturePlot(obj.mouse.IT, "nCount_RNA", reduction = "pca", pt.size = 2, raster = FALSE) + NoLegend() + xlim(-30, 35) + ylim(-45, 20) + coord_equal()
...
DimPlot(obj.opossum.IT, reduction = "pca", group.by = "sample", pt.size = 1, shuffle = TRUE, raster = FALSE) + xlim(-35, 45) + ylim(-40, 40) + coord_equal()
subclasses.opossum <- c("IT_A", "IT_B", "IT_C", "IT_D")
Idents(obj.opossum.IT) <- "subclass"
levels(obj.opossum.IT) <- subclasses.opossum
pl <- DimPlot(obj.opossum.IT, reduction = "pca", cols = colors_list[subclasses.opossum], pt.size = 1, label = TRUE, shuffle = TRUE, raster = FALSE) + NoLegend() + xlim(-35, 45) + ylim(-40, 40) + coord_equal()
pl[[1]]$layers[[1]]$aes_params$alpha =  0.8
pl
FeaturePlot(obj.opossum.IT, "nCount_RNA", reduction = "pca", pt.size = 2, raster = FALSE) + NoLegend() + xlim(-35, 45) + ylim(-40, 40) + coord_equal()
...
pl <- DimPlot(obj.mouse.IT.SVF, reduction = "pca", cols = colors_list[subclasses.mouse], pt.size = 1, label = TRUE, shuffle = TRUE, raster = FALSE) + NoLegend() + xlim(-30, 35) + ylim(-45, 20) + coord_equal()
pl[[1]]$layers[[1]]$aes_params$alpha =  0.8
pl
