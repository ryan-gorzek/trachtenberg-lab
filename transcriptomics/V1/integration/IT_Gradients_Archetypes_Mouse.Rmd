...
write.table(mouse.pcs, "E:/Transcriptomics_V1/Integration/mouse_pcs_subsample.txt", sep = " ", col.names = FALSE, row.names = FALSE)
...
mouse.polygon <- read.csv("E:/Transcriptomics_V1/Integration/mouse_polygon_subsample.csv")
