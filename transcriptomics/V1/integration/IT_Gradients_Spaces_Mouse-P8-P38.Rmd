...
obj.mouse.glutamatergic.P8 <- readRDS("E:/Transcriptomics_V1/Mouse/seurat/mouse_v1_P8_glutamatergic_processed.rds")
...
Idents(obj.mouse.glutamatergic.P8) <- "subclass"
obj.mouse.IT.P8 <- subset(obj.mouse.glutamatergic.P8, idents = c("L2/3", "L4", "L5IT", "L6IT"))
obj.opossum.IT.SS <- SubsampleObject(obj.opossum.IT, "subclass", min(table(obj.opossum.IT$subclass)))
obj.mouse.IT.P8 <- NormalizePCA(obj.mouse.IT.P8)
obj.opossum.IT.SS <- NormalizePCA(obj.opossum.IT.SS)

Idents(obj.mouse.glutamatergic.P38) <- "subclass"
obj.mouse.IT.P38 <- subset(obj.mouse.glutamatergic.P38, idents = c("L2/3", "L4", "L5IT", "L6IT"))
obj.mouse.IT.SS <- SubsampleObject(obj.mouse.IT, "subclass", min(table(obj.mouse.IT$subclass)))
obj.mouse.IT.P38 <- NormalizePCA(obj.mouse.IT.P38)
...
shared.HVFs <- SelectIntegrationFeatures(object.list = c(obj.mouse.IT.P8, obj.mouse.IT.P38), nfeatures = 3000)
obj.mouse.IT.P8$age <- "P8"
obj.mouse.IT.P38$age <- "P38"
obj.combined.IT <- merge(obj.mouse.IT.P8, obj.mouse.IT.P38)
...
DimPlot(obj.combined.IT, reduction = "pca", dims = c(2, 3), cols = c("#aaaaaa", "#c692b8"), group.by = "age", pt.size = 1, label = FALSE, shuffle = TRUE, raster = FALSE) + xlim(-50, 50) + ylim(-50, 50) + coord_equal()
DimPlot(obj.combined.IT, reduction = "pca", dims = c(2, 3), cols = colors_list[subclasses.opossum.mouse], group.by = "subclass", split.by = "age", pt.size = 1, label = TRUE, shuffle = TRUE, raster = FALSE) + NoLegend() + xlim(-50, 50) + ylim(-50, 50) + coord_equal()
