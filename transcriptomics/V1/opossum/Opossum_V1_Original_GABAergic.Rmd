...
obj.opossum.gabaergic <- readRDS("E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_orig_gabaergic.rds")
...
subclass.resolutions <- rev(list(Pvalb = 1, Sst = 2, Vip = 2, Lamp5 = 2, Frem1 = 2))
