...
seurat_obj <- readRDS("E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_gabaergic_processed.rds")
Idents(seurat_obj) <- "subclass"
seurat_obj <- subset(seurat_obj, idents = c("Vip", "Lamp5", "Frem1"))
...
seurat_obj <- SetDatExpr(
                              seurat_obj,
                              group_name = c("Vip", "Lamp5", "Frem1"), # the name of the group of interest in the group.by column
...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'CGE-OPOSSUM', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
PlotDendrogram(seurat_obj, main='CGE hdWGCNA Dendrogram')
...
seurat_obj <- ModuleConnectivity(
  seurat_obj,
  group.by = 'subclass', group_name = c("Vip", "Lamp5", "Frem1")
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Opossum/seurat/wgcna/CGE/module_networks'
)
...
EnrichrBarPlot(
  seurat_obj,
  outdir = "E:/Transcriptomics_V1/Opossum/seurat/wgcna/CGE/enrichr_plots", # name of output directory
...
saveRDS(seurat_obj, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_cge_wgcna.rds")
