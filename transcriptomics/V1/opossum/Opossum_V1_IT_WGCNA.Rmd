...
seurat_obj <- subset(seurat_obj, idents = c("IT_A", "IT_B", "IT_C", "IT_D"))
...
seurat_obj <- SetDatExpr(
                              seurat_obj,
                              group_name = c("IT_A", "IT_B", "IT_C", "IT_D"), # the name of the group of interest in the group.by column
...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'IT-OPOSSUM', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
seurat_obj <- ModuleConnectivity(
  seurat_obj,
  group.by = 'subclass', group_name = c("IT_A", "IT_B", "IT_C", "IT_D")
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Opossum/seurat/wgcna/IT/module_networks'
)
...
saveRDS(seurat_obj, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_it_wgcna.rds")
