...
data_path <- "E:/Transcriptomics_V1/Opossum/1AB/output/Extended_lt10kb_ex5kb/"
sample_IDs <- c('OpossumV1-1A', 'OpossumV1-1B')
mapping_path <- "E:/_genomes/Opossum_Mouse_Genes.txt"

data <- PreprocessData(sample_IDs, data_path, "Opossum_V1_1AB", mapping_path)
...
obj.opossum <- subset(obj.opossum, idents = c(18), invert = TRUE)
obj.opossum <- ClusterSCT(obj.opossum, c(1))
PlotClusters(obj.opossum)
...
cells.glutamatergic <- WhichCells(obj.opossum, ident = c(1, 2, 3, 6, 8, 9, 10, 11, 13, 14, 18, 19))
obj.opossum$class <- ifelse(colnames(obj.opossum) %in% cells.glutamatergic, "glutamatergic", "ambiguous")

cells.gabaergic <- WhichCells(obj.opossum, ident = c(7, 12, 15))
obj.opossum$class[cells.gabaergic] <- "gabaergic"

cells.nonneuronal <- WhichCells(obj.opossum, ident = c(4, 5, 16, 17, 20))
...
saveRDS(obj.opossum.glutamatergic, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_glutamatergic_1AB.rds")

obj.opossum.gabaergic <- subset(obj.opossum, idents = "gabaergic")
saveRDS(obj.opossum.gabaergic, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_gabaergic_1AB.rds")

obj.opossum.nonneuronal <- subset(obj.opossum, idents = "nonneuronal")
saveRDS(obj.opossum.nonneuronal, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_nonneuronal_1AB.rds")
