...
seurat_obj <- SetDatExpr(
                              seurat_obj,
                              group_name = c("IT_A", "IT_B", "IT_C", "IT_D", "L5PT", "L5NP", "L6CT"), # the name of the group of interest in the group.by column
...
seurat_obj <- ConstructNetwork(
  seurat_obj,
  tom_name = 'EXC-OPOSSUM', # name of the topological overlap matrix written to disk
  overwrite_tom = TRUE
)
...
seurat_obj <- ModuleConnectivity(
  seurat_obj,
  group.by = 'subclass', group_name = c("IT_A", "IT_B", "IT_C", "L5NP", "L5PT", "IT_D", "L6CT")
)
...
ModuleNetworkPlot(
  seurat_obj,
  outdir = 'E:/Transcriptomics_V1/Opossum/seurat/wgcna/Glutamatergic/module_networks'
)
