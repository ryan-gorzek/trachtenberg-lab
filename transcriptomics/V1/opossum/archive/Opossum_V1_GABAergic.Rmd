...
obj.opossum.gabaergic <- subset(obj.opossum.gabaergic, idents = c(10, 11, 14, 16, 17), invert = TRUE)
...
subclass.idx.opossum$SCT_snn_res.1$Pvalb <- c("1", "3", "4", "8", "11")
...
subclass.idx.opossum$SCT_snn_res.1$Sst <- c("6", "9", "10", "12")
...
subclass.idx.opossum$SCT_snn_res.1$Frem1 <- c("7")
