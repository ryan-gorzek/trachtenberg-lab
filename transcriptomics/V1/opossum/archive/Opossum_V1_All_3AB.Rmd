...
sample_IDs <- c('OpossumV1-3A', 'OpossumV1-3B')
mapping_path <- "E:/_genomes/Opossum_Mouse_Genes.txt"

data <- PreprocessData(sample_IDs, data_path, "Opossum_V1_3AB", mapping_path)
...
obj.opossum <- subset(obj.opossum, idents = c(25), invert = TRUE)
obj.opossum <- ClusterSCT(obj.opossum, c(1))
PlotClusters(obj.opossum)
...
cells.glutamatergic <- WhichCells(obj.opossum, ident = c(1, 4, 5, 6, 8, 11, 13, 14, 15, 19, 20, 21, 24, 25))
obj.opossum$class <- ifelse(colnames(obj.opossum) %in% cells.glutamatergic, "glutamatergic", "ambiguous")

cells.gabaergic <- WhichCells(obj.opossum, ident = c(7, 12, 16, 18, 23))
obj.opossum$class[cells.gabaergic] <- "gabaergic"

cells.nonneuronal <- WhichCells(obj.opossum, ident = c(2, 3, 9, 10, 17, 22, 26, 27))
...
saveRDS(obj.opossum.glutamatergic, "E:/Transcriptomics_V1/Opossum/3AB/seurat/opossum_v1_glutamatergic_3AB.rds")

obj.opossum.gabaergic <- subset(obj.opossum, idents = "gabaergic")
saveRDS(obj.opossum.gabaergic, "E:/Transcriptomics_V1/Opossum/3AB/seurat/opossum_v1_gabaergic_3AB.rds")

obj.opossum.nonneuronal <- subset(obj.opossum, idents = "nonneuronal")
saveRDS(obj.opossum.nonneuronal, "E:/Transcriptomics_V1/Opossum/3AB/seurat/opossum_v1_nonneuronal_3AB.rds")
