...
obj.opossum.gabaergic <- readRDS("E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_gabaergic_meis2.rds")
...
DimPlot(obj.opossum.gabaergic, reduction = "umap", group.by = "all_SCT_snn_res.1", label = TRUE, raster = FALSE, shuffle = TRUE) + xlim(-25, 25) + ylim(-25, 25) + coord_equal()
...
obj.opossum.gabaergic <- subset(obj.opossum.gabaergic, idents = c(9, 14, 15, 16, 18), invert = TRUE)
...
Idents(obj.opossum.gabaergic) <- "SCT_snn_res.1"
markers.7 <- FindMarkers(obj.opossum.gabaergic, ident.1 = 7)
...
subclass.idx.opossum$SCT_snn_res.1$Pvalb <- c("2", "4", "5", "9", "12") # 1, 3, 4, 6, 12
# subclass.idx.opossum$SCT_snn_res.1.5$Pvalb <- c("1", "4", "7", "9", "10", "12", "14", "16")
# subclass.idx.opossum$SCT_snn_res.2$Pvalb <- c("1", "3", "7", "8", "9", "11", "14", "16")

subclass.idx.opossum$SCT_snn_res.1$Sst <- c("8", "10", "11", "13") # 7, 8, 11, 14
# subclass.idx.opossum$SCT_snn_res.1.5$Sst <- c("3", "8", "11", "15")
# subclass.idx.opossum$SCT_snn_res.2$Sst <- c("2", "6", "10", "15")

subclass.idx.opossum$SCT_snn_res.1$Vip <- c("3") # 2
# subclass.idx.opossum$SCT_snn_res.1.5$Vip <- c("6", "13")
# subclass.idx.opossum$SCT_snn_res.2$Vip <- c("5", "13")

subclass.idx.opossum$SCT_snn_res.1$Lamp5 <- c("6") # 5
# subclass.idx.opossum$SCT_snn_res.1.5$Lamp5 <- c("2")
# subclass.idx.opossum$SCT_snn_res.2$Lamp5 <- c("12", "17")

subclass.idx.opossum$SCT_snn_res.1$Frem1 <- c("7", "14") # 9
# subclass.idx.opossum$SCT_snn_res.1.5$Frem1 <- c("5")
# subclass.idx.opossum$SCT_snn_res.2$Frem1 <- c("4")

subclass.idx.opossum$SCT_snn_res.1$Meis2 <- c("1") # 10, 13
...
markers.opossum.gabaergic <- IdentMarkerDict(obj.opossum.gabaergic, subclass.labels, ident.labels,
                                        "E:/Transcriptomics_V1/Opossum/seurat/marker_genes/markerdict_clusters.rds")
SaveDotPlots(obj.opossum.gabaergic, markers.opossum.gabaergic,
             subclass.labels, ident.labels,
             "E:/Transcriptomics_V1/Opossum/seurat/cell_types/", "ENSMODG")
SaveFeaturePlots(obj.opossum.gabaergic, markers.opossum.gabaergic,
                 subclass.labels, ident.labels,
                 "E:/Transcriptomics_V1/Opossum/seurat/cell_types/")
...
subclass.markers.opossum.gabaergic <- SubclassMarkerDict(obj.opossum.gabaergic, "subclass",
                                                       "E:/Transcriptomics_V1/Opossum/seurat/marker_genes/markerdict_subclass.rds")
markers.opossum.gabaergic <- IdentMarkerDict(obj.opossum.gabaergic, subclass.labels, ident.labels,
                                        "E:/Transcriptomics_V1/Opossum/seurat/marker_genes/markerdict_types.rds")
SaveDotPlots(obj.opossum.gabaergic, markers.opossum.gabaergic,
             subclass.labels, ident.labels,
             "E:/Transcriptomics_V1/Opossum/seurat/cell_types/", "ENSMODG")
SaveFeaturePlots(obj.opossum.gabaergic, markers.opossum.gabaergic,
...
saveRDS(obj.opossum.gabaergic, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_gabaergic_meis2_processed.rds")
