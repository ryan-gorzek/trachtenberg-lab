...
data_path <- "E:/Transcriptomics_V1/Opossum/output/Original/"
...
cells.glutamatergic <- WhichCells(obj.opossum, ident = c(2, 3, 6, 7, 8, 9, 11, 12, 13, 14, 16, 18, 19, 24, 25))
obj.opossum$class <- ifelse(colnames(obj.opossum) %in% cells.glutamatergic, "glutamatergic", "ambiguous")

cells.gabaergic <- WhichCells(obj.opossum, ident = c(5, 15, 17, 21, 22, 23, 26, 29))
obj.opossum$class[cells.gabaergic] <- "gabaergic"

cells.nonneuronal <- WhichCells(obj.opossum, ident = c(1, 4, 10, 20, 27, 28))
...
saveRDS(obj.opossum.glutamatergic, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_orig_glutamatergic.rds")

obj.opossum.gabaergic <- subset(obj.opossum, idents = "gabaergic")
saveRDS(obj.opossum.gabaergic, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_orig_gabaergic.rds")

obj.opossum.nonneuronal <- subset(obj.opossum, idents = "nonneuronal")
saveRDS(obj.opossum.nonneuronal, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_orig_nonneuronal.rds")
