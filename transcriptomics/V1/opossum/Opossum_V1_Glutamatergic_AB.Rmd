...
obj.opossum.glutamatergic <- ClusterSCT(obj.opossum.glutamatergic, c(0.2, 0.5, 1))
PlotClusters(obj.opossum.glutamatergic, group.id = "SCT_snn_res.1")
...
levels(obj.opossum.glutamatergic) <- c("IT_A", "IT_B", "IT_C", "IT_D", "IT_E","L5PT", "L5NP", "L6CT", "L6b")
