...
cells.gabaergic <- WhichCells(obj.opossum, ident = c(9, 14, 20))
...
SaveH5Seurat(obj.opossum.gabaergic, "E:/Transcriptomics_V1/Opossum/seurat/opossum_v1_gabaergic_nofilter.h5seurat", overwrite = TRUE, verbose = TRUE)
