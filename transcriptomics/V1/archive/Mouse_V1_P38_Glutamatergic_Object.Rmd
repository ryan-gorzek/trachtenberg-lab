...
data_path <- "E:/Transcriptomics_v1/Mouse/P38NR/filtered_feature_bc_matrix_glut/"
...
obj.mouse.gabaergic <- NormalizeData(obj.mouse.gabaergic, features = all.genes)
...
FeaturePlot(obj.mouse.gabaergic, reduction = "umap", features = c("Cux2"), raster = FALSE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
FeaturePlot(obj.mouse.gabaergic, reduction = "umap", features = c("Rorb"), raster = FALSE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
FeaturePlot(obj.mouse.gabaergic, reduction = "umap", features = c("Deptor"), raster = FALSE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
FeaturePlot(obj.mouse.gabaergic, reduction = "umap", features = c("Foxp2"), raster = FALSE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
FeaturePlot(obj.mouse.gabaergic, reduction = "umap", features = c("Tshz2"), raster = FALSE) + NoLegend() + xlim(-18, 18) + ylim(-18, 18) + coord_equal()
...
SaveH5Seurat(obj.mouse.gabaergic, "E:/Transcriptomics_v1/Mouse/seurat/mouse_v1_glutamatergic.h5seurat", overwrite = TRUE, verbose = TRUE)
