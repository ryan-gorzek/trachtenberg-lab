function [fitresult, zfit, fiterr, zerr, resnorm, rr] = sbxgaussfit(xx,yy,zz,lows)
...
% Modified by DLR to include lower limits on sx and sy
...
Lower = [0, 0, lows, lows, xo-2, yo-2, 0];
Upper = [2*amp, 360, 5, 5, xo+2, yo+2, Inf]; % angles greater than 90 are redundant
